...
class UserSerializer(serializers.ModelSerializer):
    ...
    def save(self):
        ...
        donor=UserModel.objects.create(email=donor_email,first_name=first_name,last_name=last_name,gender=gender,phone=phone,blood_group=blood_group,division=division,birth_date=birth_date,last_donate=last_donate,District=district)
        donor.save()
        return donor
